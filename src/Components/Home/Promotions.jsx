	...
	return (
		<div className="mb-10">
			<div className="  bold pt-10 pb-10 text-center sm:flex ">
				<h2 className="  color-main sm:text-4xl sm:bold ml-10 mr-10">PROMOCIONES BANCARIAS</h2>
			...
			<div className="sm:flex justify-evenly  hidden promos">
				<li className="h-80 w-60 bg-white ml-15 mr-15 list-none border-2 border-gray-400 ">
					<div className="h-[25%] bg-[#06023d] flex justify-center items-center text-white regular ">
						Lunes
					</div>
				...
				<li className="h-80 w-60 bg-white ml-15 mr-15 list-none border-2 border-gray-400">
					<div className="h-[25%] bg-green-800 flex justify-center items-center text-white regular ">
						Miercoles
					</div>
					<div className="h-[75%] flex flex-col justify-center items-center ">
						<h4 className="ml-5 mb-0 color-main bold text-center ">
				...
				<li className="h-80 w-60 bg-white ml-15 mr-15 list-none border-2 border-gray-400 ">
					<div className="h-[25%] bg-red-600 flex justify-center items-center text-white regular ">
						Jueves
					</div>
					<div className="h-[75%] flex flex-col justify-center items-center ">
						<h4 className="ml-5 mb-0 color-main bold text-center ">
				...
				<li className="h-80 w-60 bg-white ml-15 mr-15 list-none border-2 border-gray-400">
					<div className="h-[25%] bg-pink-300 flex justify-center items-center text-white regular">
						Viernes
					</div>
					<div className="h-[75%] flex flex-col justify-center items-center ">
						<h4 className=" ml-5 mb-0 color-main bold text-center ">
