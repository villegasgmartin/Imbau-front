...
export default function AllProducts () {
    ...
    return (
			<div className="flex flex-col ">
				...
				<h3 className="ml-40 mt-20 text-3xl text-[#06023D] bold">Productos destacados <br/> en tu zona</h3>
          ...
          {products.map((producto) => (
            <SwiperSlide key={producto._id}>
              <CardProducto producto={producto} />
				...
				<h3 className="ml-40 mt-20 text-3xl text-[#06023D] bold">Los mas <br/> vendidos</h3>
				<div className="flex justify-evenly m-6">
          ...
          {products.map((producto) => (
            <SwiperSlide key={producto._id}>
              <CardProducto producto={producto} />
				...
				<img src={banner2} alt="" className="w-[100vw] mt-10"/>
				<h3 className="ml-40 mt-20 text-3xl text-[#06023D] bold">Puede interesarte <br/> segun tus busquedas</h3>
				<div className="flex justify-evenly m-6">
