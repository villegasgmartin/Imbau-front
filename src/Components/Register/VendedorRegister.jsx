...
import { postVendedor } from '../../../redux/actions';
export default function VendedorRegister() {
	...
	const handleSubmit = () => {
		...
		// formData.append('rol', 'USER_SELLER');
		swal({
			title: 'Crear perfil?',
			...
			>
				<div className=" w-[40%] ">
					<div className="h-min-96 rounded-xl ">
						<div className="">
							<h2 className="w-[50%] bg-[#e94335] rounded-lg regular m-0 pt-2 pb-2 pl-7 text-xl">
								Vendedor
							</h2>
						</div>
